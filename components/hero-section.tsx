...
export const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-black pt-24 pb-16">
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#1a1a1a_1px,transparent_1px),linear-gradient(to_bottom,#1a1a1a_1px,transparent_1px)] bg-size-[4rem_4rem] mask-[radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-20 pointer-events-none"></div>

      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[500px] pointer-events-none">
        <div className="absolute top-[-100px] left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-[#00BCD4]/20 blur-[120px] rounded-full mix-blend-screen animate-pulse-slow"></div>
        <div className="absolute top-[-150px] left-1/2 translate-x-1/4 w-[500px] h-[400px] bg-purple-500/10 blur-[100px] rounded-full mix-blend-screen"></div>
      </div>

      <div className="absolute inset-0 w-full h-full pointer-events-none opacity-40">
        <div className="absolute top-1/4 left-1/4 w-1 h-1 bg-white rounded-full animate-ping duration-[3s]"></div>
        <div className="absolute top-1/3 right-1/3 w-1 h-1 bg-[#00BCD4] rounded-full animate-pulse duration-[4s]"></div>
        <div className="absolute bottom-1/3 left-1/5 w-0.5 h-0.5 bg-white rounded-full animate-ping duration-[5s]"></div>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-6xl px-4 md:px-6">
        <div className="group relative inline-flex items-center gap-2.5 px-5 py-2 rounded-full bg-zinc-900/50 border border-white/10 backdrop-blur-xl shadow-lg shadow-[#00BCD4]/5 mb-10 transition-all hover:border-[#00BCD4]/30 hover:bg-zinc-900/80 cursor-default overflow-hidden">
          ...
          <div className="flex h-2.5 w-2.5 relative items-center justify-center">
            ...
            <span className="relative inline-flex rounded-full h-2 w-2 bg-[#00BCD4] shadow-[0_0_10px_#00BCD4]"></span>
          </div>
        ...
        <h1 className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter text-white mb-8 leading-[0.9] drop-shadow-2xl">
          ...
          <span className="relative inline-block pb-2">
            <span className="absolute inset-0 bg-[#00BCD4] blur-[60px] opacity-20 pointer-events-none"></span>
        ...
        <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto items-center">
          ...
          >
            <div className="absolute top-0 -left-full w-full h-full bg-linear-to-r from-transparent via-zinc-300/30 to-transparent skew-x-[-25deg] animate-[shine_3s_infinite]"></div>
          ...
          {[
            ...
            >
              <div className="relative p-3.5 rounded-2xl bg-zinc-900/50 border border-white/5 group-hover:border-[#00BCD4]/30 group-hover:bg-[#00BCD4]/5 transition-all duration-300">
                <div className="absolute inset-0 bg-[#00BCD4] blur-xl opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
